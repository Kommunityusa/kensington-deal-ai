-- Remove old Zillow cron job and add Redfin cron job
SELECT cron.unschedule('scrape-zillow-daily');

-- Schedule Redfin scraping to run once per day at 3 AM
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
        url:='https://wypmanbdmdegxylgvvhx.supabase.co/functions/v1/scrape-redfin',
